...
public class Components {
    ...
    private void generateCsvFile(String fileName) {
        try {
            ...
            BigDecimal gbsOnlyHP = new BigDecimal(it3.getValue().toString()).add(new BigDecimal(it5.getValue().toString()).add(new BigDecimal(it8.getValue().toString())));
            writer.append("ONLY HIGH PERFORMANCE STORAGE,,"+gbsOnlyHP.doubleValue()+","+gbsOnlyHP.multiply(new BigDecimal(it6.getValue().toString())));
            writer.append(System.getProperty("line.separator"));
            
            writer.append("PARTITIONING");
            writer.append(System.getProperty("line.separator"));
            writer.append(",");
            writer.append("High Performance Storage,"+new BigDecimal(it3.getValue().toString()).doubleValue()+","+new BigDecimal(ot1.getValue().toString()).doubleValue());
            writer.append(System.getProperty("line.separator"));
            writer.append(",");
            writer.append("Modular Storage,"+new BigDecimal(it8.getValue().toString()).doubleValue()+","+new BigDecimal(ot2.getValue().toString()).doubleValue());
            writer.append(System.getProperty("line.separator"));
            writer.append(",");
            writer.append("Read-Only Storage,"+new BigDecimal(it5.getValue().toString()).doubleValue()+","+new BigDecimal(ot3.getValue().toString()).doubleValue());
            writer.append(System.getProperty("line.separator"));

            writer.append("PARTITIONING + ADVANCE COMPRESSION FACTOR "+new BigDecimal(it10.getValue().toString()).doubleValue());
            writer.append(System.getProperty("line.separator"));
            writer.append(",");
            writer.append("High Performance Storage,"+new BigDecimal(it3.getValue().toString()).divide(new BigDecimal(it10.getValue().toString()), 2, RoundingMode.HALF_UP).doubleValue()+","+new BigDecimal(ot1.getValue().toString()).divide(new BigDecimal(it10.getValue().toString()), 2, RoundingMode.HALF_UP).doubleValue());
            writer.append(System.getProperty("line.separator"));
            writer.append(",");
            writer.append("Modular Storage,"+new BigDecimal(it8.getValue().toString()).divide(new BigDecimal(it10.getValue().toString()), 2, RoundingMode.HALF_UP).doubleValue()+","+new BigDecimal(ot2.getValue().toString()).divide(new BigDecimal(it10.getValue().toString()), 2, RoundingMode.HALF_UP).doubleValue());
            writer.append(System.getProperty("line.separator"));
            writer.append(",");
            writer.append("Read-Only Storage,"+new BigDecimal(it5.getValue().toString()).divide(new BigDecimal(it10.getValue().toString()), 2, RoundingMode.HALF_UP).doubleValue()+","+new BigDecimal(ot3.getValue().toString()).divide(new BigDecimal(it10.getValue().toString()), 2, RoundingMode.HALF_UP).doubleValue());
            writer.append(System.getProperty("line.separator"));
    ...
    public List getTabularData() {
        ...
        BigDecimal hpPartitioningAmount = new BigDecimal(ot1.getValue().toString());
        BigDecimal mPartitioningAmount = new BigDecimal(ot2.getValue().toString());
        BigDecimal ropPartitioningAmount = new BigDecimal(ot3.getValue().toString());
        
        BigDecimal factorValue = new BigDecimal(it10.getValue().toString());
        
        BigDecimal hpAdvCompression = new BigDecimal(ot1.getValue().toString());
        BigDecimal mAdvCompression = new BigDecimal(ot2.getValue().toString());
        BigDecimal ropAdvCompression = new BigDecimal(ot3.getValue().toString());
        ...
        String[] rowLabels = new String[] { "High Performance Storage", "Modular Storage", "ReadOnly Storage"};
        String[] colLabels = new String[] { "Only High Performance", "Partitioning", "Partitioning + AdvCompression"};
        BigDecimal[][] values =
            new BigDecimal[][] { 
            /* High Performance Storage Row */ {hpGbs , hpPartitioningAmount, hpAdvCompression},
            /* Modular Storage Row */          {new BigDecimal(0.0) , mPartitioningAmount, mAdvCompression},
            /* Read Only Storage Row */        {new BigDecimal(0.0) , ropPartitioningAmount, ropAdvCompression}
                                };
